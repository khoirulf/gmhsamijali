                      ...
                      <section class="panel">
                          ...
                          <div class="table-responsive">
                            <table class="table">
                              ...
                              <tbody>
                              <form method="post" action="<?php echo base_url().'index.php/C_adminInstructor/delproduk'?>">

                                <?php foreach ($data as $x) { ?>

                                <tr>
                                    <td><input type="checkbox" value="<?= $x['id_instructor'] ?>" name="item[]"></td>
                                    <td><?= $x['id_instructor'] ?></td>
                                    <td><?= $x['nama_instructor'] ?></td>
                                    <td><?= $x['keahlian'] ?></td>
                                    
                        
                                    <td style="width:10px, height:10px;"> <img src="<?php echo base_url().'upload/'.$x['gambar']; ?>" height="100" width="100"></td>

                                     <td align="center">
                                        <a href="<?php echo base_url().'upload/'.$x['cv'];?>">download CV</a> 
                                    </td> 
                                    <td align="center">
                                        <a href="<?php echo base_url()."index.php/c_adminInstructor/delproduk/".$x['id_instructor'];?>">Delete</a>
                                    </td>
                                </tr>        
